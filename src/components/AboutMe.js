...
import img2 from '../assets/selfie3.jpg';
import img3 from '../assets/selfie4.jpg';
import cv from '../assets/Sahd_Khan_Software_Developer.pdf';
	...
	return (
		<div id="about" className="w-full flex-col flex lg:items-center lg:flex-row justify-center  ">
			...
			>
				...
				<p className="text-xs md:text-sm lg:text-base  mb-5 font-main tracking-wide text-gray-500 text-justify xl:w-5/6">
