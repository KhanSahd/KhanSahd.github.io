...
export default function Hero() {
	...
	return (
		...
		>
			...
			<div className="bg-blue-100 w-16 h-16 absolute bottom-32 max-md:bottom-24 max-sm:bottom-6 rotate-45"></div>
			<div className="absolute bottom-36 max-md:bottom-28 max-sm:bottom-10">
